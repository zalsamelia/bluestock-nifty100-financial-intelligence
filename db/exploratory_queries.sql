...
-- ============================================================
-- The sectors table contains one row per company.
-- Therefore, there is no "latest year" concept here.
-- The confirmed columns are:
-- sector, industry, weight, market_cap_category.
-- ============================================================
